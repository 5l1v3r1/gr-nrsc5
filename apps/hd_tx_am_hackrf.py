...
class hd_tx_am_hackrf(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_null_source_0_0 = blocks.null_source(gr.sizeof_char*3750)
        ...
        self.blocks_keep_m_in_n_0 = blocks.keep_m_in_n(gr.sizeof_gr_complex, 270, 512, 0)
        ...
        self.connect((self.blocks_null_source_0_0, 0), (self.nrsc5_l1_am_encoder_ma1_0, 0))
